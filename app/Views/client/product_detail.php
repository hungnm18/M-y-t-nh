        ...
        <div class="col-lg-6">
            <div class="ps-lg-3">
                ...
                <div class="d-flex align-items-center mb-3">
                    ...
                    <div class="border-start ps-3 text-success fw-semibold">
                ...
                <form action="<?= ($_ENV['APP_URL'] ?? '') ?>/cart/add" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="quantity-selector input-group">
                            <button class="btn btn-outline-secondary" type="button" onclick="decrementQuantity()"><i class="fa-solid fa-minus"></i></button>
                            <input type="number" id="quantityInput" name="quantity" class="form-control text-center" value="1" min="1" max="<?= $product['quantity'] ?? 50 ?>">
                            <button class="btn btn-outline-secondary" type="button" onclick="incrementQuantity()"><i class="fa-solid fa-plus"></i></button>
                        </div>
                    </div>

                    <!-- Nút Thêm Giỏ & Mua Ngay -->
                    <div class="d-grid gap-2 d-md-flex mt-4">
                        <button type="submit" name="action" value="add" class="btn btn-outline-dark-custom btn-lg flex-fill py-3">
                            <i class="fa-solid fa-cart-plus me-2"></i> THÊM VÀO GIỎ
                        </button>
                        <button type="submit" name="action" value="buy_now" class="btn btn-red btn-lg flex-fill py-3">
