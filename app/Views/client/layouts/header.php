...
<head>
    ...
    <title><?= htmlspecialchars($title ?? 'Website Bán Giày Thể Thao') ?></title>
    <!-- Meta SEO -->
            ...
            <div class="collapse navbar-collapse" id="mainNavbar">
                ...
                <div class="d-flex align-items-center">
                    <a href="<?= base_url('cart') ?>" class="header-icon-link me-2" title="Giỏ hàng">
                        ...
                        <span class="badge-badge-count"><?= isset($_SESSION['cart']) ? count($_SESSION['cart']) : 0 ?></span>
                    </a>
                    ...
                    <div class="dropdown dropdown-hover d-inline-block position-relative ms-1">
                        ...
                        <ul class="dropdown-menu custom-dropdown-menu auth-dropdown-menu">
                            <?php if (isset($_SESSION['user'])): ?>
                                ...
                                <li><a class="dropdown-item text-start" href="<?= base_url('account') ?>">Tài khoản của tôi</a></li>
